...
import numpy as np
from GPy.kern import Kern, RBF, Add
...
@multimethod
def _compute_mean(prior: Gaussian, gp: WsabiLGP, kernel: Add) -> float:
    return sum([_compute_mean(prior, gp, p) for p in kernel.parts])